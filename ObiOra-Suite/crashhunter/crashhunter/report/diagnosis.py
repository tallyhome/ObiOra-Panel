...
PATTERNS: list[tuple[str, str, float, str]] = [
    ...
    (r"rcu stall|RCU stall", "rcu_stall", 0.95, "critical"),
    ...
    (r"BUG:|Oops:|Call Trace:", "driver_crash", 0.86, "critical"),
...
class DiagnosisEngine:
    ...
    def analyze(self, correlation: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "findings": findings,
            "top_suspicious_events": suspicious[:20],
            "summary": self._build_summary(findings[0], suspicious),
        }
    ...
    def _build_summary(
        ...
        parts = [
            f"Cause probable: {primary['title']} (confiance {primary['confidence']:.0%}).",
            primary["description"],
        ]
        if suspicious:
