...
return [
    ...
    ['slug' => 'sickchill', 'name' => 'SickChill', 'category' => 'media', 'description' => 'Gestionnaire de séries TV (fork SickBeard).', 'type' => 'docker', 'image' => 'lscr.io/linuxserver/sickchill:latest', 'port' => 8091],
    ['slug' => 'sickgear', 'name' => 'SickGear', 'category' => 'media', 'description' => 'Gestionnaire de séries TV.', 'type' => 'docker', 'image' => 'lscr.io/linuxserver/sickgear:latest', 'port' => 8092],
    ['slug' => 'sonarr', 'name' => 'Sonarr', 'category' => 'media', 'description' => 'Gestion et téléchargement de séries TV.', 'type' => 'native'],
    ['slug' => 'sonarrold', 'name' => 'Sonarr (v2)', 'category' => 'media', 'description' => 'Ancienne version Sonarr v2 (legacy).', 'type' => 'docker', 'image' => 'lscr.io/linuxserver/sonarr:version-2.0.0.5161-ls3', 'port' => 8990],
    ['slug' => 'subsonic', 'name' => 'Subsonic', 'category' => 'media', 'description' => 'Serveur de streaming musical.', 'type' => 'docker', 'image' => 'linuxserver/subsonic', 'port' => 4042],
    ...
    // --- Cloud / stockage ---
    ['slug' => 'calibre', 'name' => 'Calibre', 'category' => 'cloud', 'description' => 'Gestion d\'ebooks et bibliothèque.', 'type' => 'docker', 'image' => 'lscr.io/linuxserver/calibre:latest', 'port' => 8089],
    ['slug' => 'calibrecs', 'name' => 'Calibre Content Server', 'category' => 'cloud', 'description' => 'Serveur de contenu Calibre.', 'type' => 'docker', 'image' => 'lscr.io/linuxserver/calibre:latest', 'port' => 8093],
    ...
    ['slug' => 'filebrowser', 'name' => 'File Browser', 'category' => 'cloud', 'description' => 'Gestionnaire de fichiers web.', 'type' => 'docker', 'image' => 'filebrowser/filebrowser:latest', 'port' => 8082],
    ['slug' => 'headphones', 'name' => 'Headphones', 'category' => 'media', 'description' => 'Gestionnaire de musique automatique (legacy).', 'type' => 'docker', 'image' => 'linuxserver/headphones', 'port' => 8183],
    ['slug' => 'mango', 'name' => 'Mango', 'category' => 'cloud', 'description' => 'Lecteur de mangas self-hosted.', 'type' => 'docker', 'image' => 'gotson/komga', 'port' => 25600],
    ['slug' => 'nextcloud', 'name' => 'Nextcloud', 'category' => 'cloud', 'description' => 'Suite bureautique et cloud privé.', 'type' => 'docker', 'image' => 'lscr.io/linuxserver/nextcloud:latest', 'port' => 8443],
    ['slug' => 'organizr', 'name' => 'Organizr', 'category' => 'cloud', 'description' => 'Page d\'accueil pour vos services.', 'type' => 'docker', 'image' => 'organizr/organizr', 'port' => 8086],
    ...
    // --- Monitoring ---
    ['slug' => 'librespeed', 'name' => 'LibreSpeed', 'category' => 'monitoring', 'description' => 'Test de débit réseau self-hosted.', 'type' => 'docker', 'image' => 'linuxserver/librespeed', 'port' => 8088],
    ...
    ['slug' => 'xmrig', 'name' => 'XMRig', 'category' => 'tools', 'description' => 'Mineur Monero (CPU/GPU) — usage à vos risques.', 'type' => 'docker', 'image' => 'metal3d/xmrig', 'port' => 8090],
    ['slug' => 'xmr-stak', 'name' => 'XMR-Stak', 'category' => 'tools', 'description' => 'Mineur multi-algo (legacy) — usage à vos risques.', 'type' => 'docker', 'image' => 'metal3d/xmrig', 'port' => 8094],
